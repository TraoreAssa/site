...
<head>
    ...
    <!-- JS Commentaires -->
    <!-- <script src="Ajax-commentaires/com.js"></script> -->
    <!-- <script src="Ajax-commentaires/com.js"></script> -->
...
<body>
    ...
    // require('Ajax-commentaires/commentaires.php');
    // require_once('CV/Ajax-commentaires/formulaire.php');
    ...
    <!-- FOOTER -->
    <footer class=" footer bg-dark text-center text-white p-2">
