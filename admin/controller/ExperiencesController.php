...
// EXECUTION DES FONCTIONS (qui sont dans EntityExperiencesRepository qu'ont rappel pour les fonctionnalité d'affichage  )
...
class ExperiencesController
{
    ...
    {
        $this->db = new \model\EntityExperiencesRepository;
        // permet de récuperer une connexion a la BDD dans EntityExperiencesRepository.php
    }
