    ...
    public function save($op)
    {
        ...
        if ($_POST) {
                ...
                $this->redirect('utilisateur.php');
                        ...
                        // $verif_caractere= preg_match("#^'[a-zA-Z0-9._]+$#", $_POST['nom']);//le pattern prend 2 param: les caracteres autorisés dans la valeur:( tout ce qui est entre les # est accepté), et la variable qui reçoit lesdits caracteres, ici $_POST['pseudo']
