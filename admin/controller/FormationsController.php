...
// EXECUTION DES FONCTIONS (qui sont dans EntityFormationsRepository qu'ont rappel pour les fonctionnalité d'affichage  )
class FormationsController
{
    private $db;
    public function __construct()
    {
        $this->db = new \model\EntityFormationsRepository; 
        // permet de récuperer une connexion a la BDD dans EntityFormationsRepository.php
    }    
